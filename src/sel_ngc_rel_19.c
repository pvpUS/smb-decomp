/*
 * sel_ngc_rel.c -- REL module: isolated function lbl_0000A4A0.
...
void lbl_0000A4A0(struct Sprite *sprite);
...
// sprite drawFunc: skip the preview blit while the stage intro is still running.
void lbl_0000A4A0(struct Sprite *sprite)
{
    if (sprite->bmpId == 0 && *(s32 *)lbl_100000C0 == 0
