/*
 * sel_ngc_rel.c -- REL module: isolated function lbl_0000A6C8.
...
void lbl_0000A6C8(char *filename);
...
// create the full-screen preview sprite (once).
void lbl_0000A6C8(char *filename)
{
    ...
    {
        pv = p + 0x960;
        preview_create(pv, filename, 0, 640, 480, 14);
        *(u16 *)(p + 0x962) |= 2;
        *(u8 **)((u8 *)sprite + 0x2C) = pv;
        sprite->tag = 0x63;
        sprite->x = *(f32 *)(tbl + 0x6C);
        sprite->y = *(f32 *)(tbl + 0x6C);
        sprite->depth = *(f32 *)(tbl + 0x138);
        sprite->scaleX = *(f32 *)(tbl + 0x13C);
        sprite->scaleY = *(f32 *)(tbl + 0x140);
        sprite->flags |= 0x40000;
        sprite->mainFunc = (void (*)(s8 *, struct Sprite *))lbl_0000A7B0;
        sprite->drawFunc = (void (*)(struct Sprite *))lbl_0000A7D4;
        sprite->destFunc = (void (*)(struct Sprite *))lbl_0000A840;
    }
    *(s32 *)(p + 0x9D4) = 1;
}
