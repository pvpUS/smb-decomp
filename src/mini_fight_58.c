 ...
 * byte-matching (part 58 of 94; contiguous .text range).  Each function
...
void lbl_00010ADC(struct Ball *ball)
{
...
static void lbl_00010B48(struct Ball *ball)
{
    u8 *p = (u8 *)lbl_0001C348;

    ball->vel.x = *(f32 *)(p + 0x1C);
    ball->vel.y = *(f32 *)(p + 0x1C);
    ball->vel.z = *(f32 *)(p + 0x1C);
    ball->state = 0x18;
    ball->unk148 = 0x26;
    lbl_00010B98(ball);
}
