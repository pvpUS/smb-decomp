 ...
 * byte-matching (part 39 of 41; contiguous .text range).  Each function
...
asm void lbl_0001075C(void)
{
    nofralloc
#include "../asm/nonmatchings/mini_race/lbl_0001075C.s"
}
static asm void lbl_000107D0(void)
{
    nofralloc
