 ...
 * byte-matching (part 7 of 56; contiguous .text range).  Each function
...
int lbl_00001B38(void)
{
    ...
    case GAMETYPE_MINI_FIGHT:
        n = u_count_pads();
        if (*(s8 *)((u8 *)&lbl_801EEDA8 + 0x114) != n)
            ret = 1;
        break;
    case GAMETYPE_MINI_RACE:
        if (lbl_801EED88.unkC & 2)
            break;
        n = u_count_pads();
        if (*(s8 *)((u8 *)&lbl_801EEDA8 + 0x114) != n)
            ret = 1;
    ...
    if (ret)
    {
        if (*(s32 *)((u8 *)&lbl_801EEDA8 + 0x44) == 0)
        {
            ...
            textbox_add_text(1, (char *)lbl_0001225C);
            *(s32 *)((u8 *)&lbl_801EEDA8 + 0x44) = 1;
