...
/* @BODY */
// INVENTED -- per-racer 0x29C-stride records at lbl_10000000 + 0x108C.  UNVERIFIED.
struct RaceRec
{
    /*0x00*/ s16 unk0;
    u8 filler2[0x29C - 2];
...
void lbl_00001040(void)
{
    ...
    *(s32 *)(w + 0x3C) = 0x12C;
    ...
    {
        if ((s8)ball->unk0 == 2 &&
            !(((struct RaceSub *)ball->unk144)->unk14 & 0x40) &&
            !(((struct RaceSub *)ball->unk144)->unk14 & 0x40))
            ((struct RaceRec *)(w + 0x108C))[ball->playerId].unk0 = 0x12C;
    }
    lbl_00010218(*(s32 *)(w + 0x3C) - 180);
