/*
 * test_mode.c -- REL module: isolated function lbl_0000BFA0.
...
{
    lbl_0000C1B8();
    if (*(struct TPL **)lbl_10000FA8 != NULL)
    {
        bitmap_free_tpl(*(struct TPL **)lbl_10000FA8);
        *(struct TPL **)lbl_10000FA8 = NULL;
    }
}
