/*
 * sel_ngc_rel.c -- REL module: isolated function lbl_00011824.
...
void lbl_00011824(struct Sprite *sprite);
void lbl_000118E4(void);

#pragma force_active on
// sprite drawFunc: the sprite's own caption plus the play-point total.
void lbl_00011824(struct Sprite *sprite)
{
    u8 *tbl = lbl_00011CB0;
    ...
    set_text_scale(*(f32 *)(tbl + 0x4A4), *(f32 *)(tbl + 0x4A4));
    set_text_pos(*(f32 *)(tbl + 0x4A8) + sprite->x, sprite->y);
    sprite_printf((char *)lbl_00017490, *(s32 *)g_totalPlayPoints);
}
