/*
 * sel_ngc_rel.c -- REL module: isolated function lbl_0000A7D4.
...
void lbl_0000A7D4(struct Sprite *sprite);
...
// sprite drawFunc: blit the preview image with the sprite's colours/transform.
void lbl_0000A7D4(struct Sprite *sprite)
{
