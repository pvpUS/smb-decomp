/*
 * mini_golf.c -- REL module: isolated function run lbl_00025B10 .. lbl_00025B70.
...
void lbl_00025B10(void (*fn)(void))
{
    Func802F20F0 saved = u_avdisp_set_some_func_2((Func802F20F0)lbl_0002609C);
    if (fn)
        fn();
    u_avdisp_set_some_func_2(saved);
}
void lbl_00025B70(void (*fn)(void))
{
    Func802F20F0 saved = u_avdisp_set_some_func_2((Func802F20F0)lbl_000260C0);
    if (fn)
        fn();
    u_avdisp_set_some_func_2(saved);
}
