/*
 * mini_fight.c -- REL module: isolated function run lbl_0000D890 .. lbl_0000D8B4.
...
void lbl_0000D890(u8 *p);
void lbl_0000D8B4(u8 *p);
...
void lbl_0000D890(u8 *p)
{
    *(s32*)(lbl_10017578 + (s8)p[0x2e] * 0x38) = 1;
}
void lbl_0000D8B4(u8 *p)
{
    *(s32*)(lbl_10017578 + (s8)p[0x2e] * 0x38) = 3;
}
