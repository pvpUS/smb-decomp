/*
 * mini_pilot.c -- REL module: isolated function run lbl_000003B4 .. lbl_0000047C.
...
{
    event_finish_all();
    OSFreeToHeap(stageHeap, *(void **)lbl_1000003C);
    OSFreeToHeap(stageHeap, *(void **)lbl_10000038);
    if (*(u32 *)lbl_802F1FD0 & 4) {
...
static void lbl_0000047C(void)
{
    if (*(s16 *)lbl_802F1FF4 != -1) {
        lbl_802F1FF6 = *(s16 *)lbl_802F1FF4;
        *(s16 *)lbl_802F1FF4 = -1;
    }
