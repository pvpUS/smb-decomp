 ...
 * byte-matching (part 4 of 50; contiguous .text range).  Each function
...
void lbl_0000AF68(void *buf, int size);
...
void lbl_000001F8(void)
{
    ...
    *(void **)(w + 0x38) = OSAllocFromHeap(stageHeap, 0xA00C);
    *(void **)(w + 0x3C) = OSAllocFromHeap(stageHeap, 0x1400C);
    lbl_0000AF68(*(void **)(w + 0x38), 0x400);
    lbl_0000AF68(*(void **)(w + 0x3C), 0x800);
}
