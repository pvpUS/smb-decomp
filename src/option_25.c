 ...
 * byte-matching (part 25 of 60; contiguous .text range).  Each function
...
void lbl_00003C6C(void)
{
    ...
    if ((g_currPlayerButtons[2] & 8) || (g_currPlayerAnalogButtons[2] & 8)
     || (g_currPlayerButtons[2] & 4) || (g_currPlayerAnalogButtons[2] & 4))
        sel = !sel;
    ...
    if (*btn & 0x100)
    {
        ...
        {
            lbl_00004204(0x5E);
            gameSubmodeRequest = 0xB2;
        }
        else if (*(s32 *)(w + 0x18) == 1)
        {
            lbl_00004204(0x5E);
            gameSubmodeRequest = 0xC4;
        }
    }
    else if (*btn & 0x200)
    {
