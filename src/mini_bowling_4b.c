...
extern void SoundEffect(int arg0, int arg1);
extern void u_play_sound_0(int arg0);
...
void lbl_00000718(void)
{
    ...
    *(s32 *)w = *(s32 *)w - 1;
    ...
    SoundEffect((s32)(*(f64 *)lbl_00010CC0 * currentBall->pos.z),
                (s32)(*(f64 *)lbl_00010CC8 * currentBall->pos.z));
    if (*(s32 *)(w + 0x144) > 0)
        *(s32 *)(w + 0x144) = *(s32 *)(w + 0x144) - 1;
    mode = *(u32 *)q;
    if (mode == 0x200)
        return;
    if ((s32)lbl_802F1BF0 != 1)
    {
        if ((controllerInfo[playerControllerIDs[currentBall->playerId]].pressed.button & 0x400)
            && (*(s32 *)(q + 4) & 1) && !(mode & 0x100))
        {
            *(s8 *)(q + 8) = !*(s8 *)(q + 8);
            u_play_sound_0(0x98);
        }
        if (*(s8 *)(q + 8) != 0 && *(s8 *)(q + 9) > 3)
            *(s8 *)(q + 9) = *(s8 *)(q + 9) - 1;
        else if (*(s8 *)(q + 8) == 0 && *(s8 *)(q + 9) < 0xa)
            *(s8 *)(q + 9) = *(s8 *)(q + 9) + 1;
    }
