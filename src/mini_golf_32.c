/*
 * mini_golf.c -- REL module: isolated function lbl_0000F11C.
...
void lbl_0000F11C(u8* s, Vec* out, f32 t)
{
    out->x = interpolate_keyframes(*(int*)(s + 0x18), *(struct Keyframe**)(s + 0x1c), t);
    out->y = interpolate_keyframes(*(int*)(s + 0x20), *(struct Keyframe**)(s + 0x24), t);
    out->z = interpolate_keyframes(*(int*)(s + 0x28), *(struct Keyframe**)(s + 0x2c), t);
}
