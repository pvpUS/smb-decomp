/*
 * sel_ngc_rel.c -- REL module: isolated function lbl_0000259C.
...
extern struct SelNgcMenu *lbl_802F1FB4;
...
void lbl_0000259C(void)
{
    if ((lbl_802F1FB4->flags & 8) == 0)
    {
        if (is_floor_visited(2, 1, 0x10))
            lbl_802F1FB4->flags |= 0x18;
        else if (is_floor_visited(0, 1, 8) || is_floor_visited(1, 1, 8)
              || is_floor_visited(2, 1, 8))
            lbl_802F1FB4->flags |= 8;
    }
    else if (lbl_802F1FB4->flags & 0x10)
    {
        lbl_802F1FB4->flags &= ~0x10;
        lbl_802F1FB4->unk2 = 2;
    }
    else if (lbl_802F1FB4->flags & 8)
        lbl_802F1FB4->flags &= ~8;
}
