/*
 * mini_pilot.c -- REL module: isolated function lbl_00006A94.
...
void lbl_00006A94(struct Ball *ball, struct PhysicsBall *physBall)
{
    ...
    if (lbl_802F1FF6 >= 0x12)
    {
        if (lbl_80285A80[modeCtrl.currPlayer].unk8 != 0)
            physBall->friction = *(f32 *)(k + 0x418);
        else if (lbl_80285A80[modeCtrl.currPlayer].unk4 != 0)
            physBall->friction = *(f32 *)(k + 0x41C);
        else
            physBall->friction = *(f32 *)(k + 0x420);
    }
    else if (*(u32 *)lbl_802F1FD0 & 0x20)
        physBall->friction = *(f32 *)(k + 0x1D0);
    else
        physBall->friction = *(f32 *)(k + 0x420);
}
