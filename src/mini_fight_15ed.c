...
void lbl_00008928(struct Effect *);
...
void lbl_00008928(struct Effect *effect)
{
    u8 *k = lbl_0001C108;
    f32 s = *(f32 *)(k + 0x78) * effect->colorFactor;

    mathutil_mtxA_from_mtxB_translate(&effect->pos);
    mathutil_mtxA_scale_s(*(f32 *)(k + 0x78) * effect->colorFactor);
    mathutil_mtxA_rotate_y(*(f32 *)(k + 0x88) * effect->colorFactor);
