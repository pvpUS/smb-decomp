 ...
 * byte-matching (part 18 of 53; contiguous .text range).  Each function
...
static asm void lbl_00002704(void)
{
    nofralloc
#include "../asm/nonmatchings/option/lbl_00002704.s"
}
