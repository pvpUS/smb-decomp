/*
 * mini_bowling.c -- REL module: isolated function lbl_0000BDE0.
...
void lbl_0000BDE0(Vec *v, Vec *normal, Vec *out, f32 e, f32 f);
...
// lbl_0000BDE0 (0xBDE0): split `v` into its component along `normal` and the
// component perpendicular to it, then recombine them with the two coefficients.
// lbl_00014CB8 is the double -1.0.
void lbl_0000BDE0(Vec *v, Vec *normal, Vec *out, f32 e, f32 f)
{
    Vec sp28;
    Vec sp1c;
    ...
    dot = mathutil_vec_dot_prod(normal, v);
    t = *(f64 *)lbl_00014CB8 - e;
    sp28.x = normal->x * dot;
    sp28.y = normal->y * dot;
    sp28.z = normal->z * dot;
    sp1c.x = v->x - sp28.x;
    sp1c.y = v->y - sp28.y;
    sp1c.z = v->z - sp28.z;
    out->x = t * sp28.x - f * sp1c.x;
    out->y = t * sp28.y - f * sp1c.y;
    out->z = t * sp28.z - f * sp1c.z;
}
