 ...
 * byte-matching (part 11 of 57; contiguous .text range).  Each function
...
// NOTE: src/sound.h declares SoundIcsReq(u32,u8,s8); this TU passes the two
// level arguments untruncated, so it must have seen plain int parameters.
