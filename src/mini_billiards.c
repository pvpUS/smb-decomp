/*
 * mini_billiards.c -- REL module: isolated function _prolog.
...
void _prolog(void)
{
    set_minigame_callbacks(lbl_00000F34, lbl_0000E8D0, NULL,
                           (void (*)(struct Camera *, struct Ball *))lbl_0000C85C);
    lbl_000001E0();
    gameSubmodeRequest = 0x9d;
}
