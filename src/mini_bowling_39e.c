 ...
 * byte-matching (part 39 of 57; contiguous .text range).  Each function
...
// Field NAMES here are INVENTED; only the offsets come from the code.
struct BowlPin {
    u32 flags;                 // 0x000
...
// 0x14-byte entries of the table whose base pointer lives at lbl_00014800+0x3a8.
struct BowlPinPt {
    u8 filler0[0x10];
    f32 unk10;                 // 0x10
};
