 ...
 * byte-matching (part 60 of 94; contiguous .text range).  Each function
...
int lbl_000117CC(int, struct Ball *);
...
int lbl_000117CC(int unused, struct Ball *ball)
{
    int n;

    n = modeCtrl.playerCount - lbl_10017664.sub[ball->playerId].unk10;
    n--;
    if (n < 2)
        return 2;
    if (n > 3)
