 ...
 * byte-matching (part 17 of 56; contiguous .text range).  Each function
...
void lbl_00002D00(void)
{
    ...
    *(s32 *)((u8 *)&lbl_801EEDA8 + 0x00) = 7;
    *(s32 *)((u8 *)&lbl_801EEDA8 + 0x04) = -1;
    *(s32 *)((u8 *)&lbl_801EEDA8 + 0x08) = 0;
    *(s16 *)((u8 *)&lbl_801EEDA8 + 0x0C) = -1;
    *(s16 *)((u8 *)&lbl_801EEDA8 + 0x0E) = 0;
    ((s32 *)((u8 *)&lbl_801EEDA8 + 0x10))[*(s16 *)((u8 *)&lbl_801EEDA8 + 0x0E)] = *(s32 *)((u8 *)&lbl_801EEDA8 + 0x00);
    *(s32 *)((u8 *)&lbl_801EEDA8 + 0x68) = -1;
    for (i = 0; i < 10; i++)
    {
        *(s32 *)((u8 *)&lbl_801EEDA8 + i * 4 + 0x6C) = -1;
        *(s32 *)((u8 *)&lbl_801EEDA8 + i * 4 + 0x94) = -1;
    }
    *(s32 *)((u8 *)&lbl_801EEDA8 + 0x110) = 0;
    i = lbl_00001910();
    *(s32 *)((u8 *)&lbl_801EEDA8 + 0x40) = 1;
    *(s32 *)((u8 *)&lbl_801EEDA8 + 0x3C) = i;
    modeCtrl.playerCount = *(s32 *)((u8 *)&lbl_801EEDA8 + 0x3C);
    for (i = 0; i < 4; i++)
        playerCharacterSelection[i] = ((s8 *)&lbl_802F1C10)[i + 4];
    *(s32 *)((u8 *)&lbl_801EEDA8 + 0x48) = 0;
    *(s32 *)((u8 *)&lbl_801EEDA8 + 0x4C) = 0;
    *(s32 *)((u8 *)&lbl_801EEDA8 + 0x50) = 0;
    *(s32 *)((u8 *)&lbl_801EEDA8 + 0x54) = 0;
    *(s32 *)((u8 *)&lbl_801EEDA8 + 0x44) = 0;
    lbl_00000234();
    lbl_0000033C();
    func_800123DC();
    start_screen_fade(FADE_IN | FADE_ABOVE_SPRITES, 0, 30);
}
