 ...
 * byte-matching (part 25 of 38; contiguous .text range).  Each function
...
asm void lbl_0000B4A0(void)
{
    nofralloc
#include "../asm/nonmatchings/test_mode/lbl_0000B4A0.s"
}
...
static asm void lbl_0000B6B0(void)
{
    nofralloc
