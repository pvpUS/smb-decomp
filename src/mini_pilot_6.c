 ...
 * byte-matching (part 6 of 50; contiguous .text range).  Each function
...
struct PilotWork
{
    /*0x00*/ u8 filler0[0x08];
    /*0x08*/ u32 unk8[4];
    /*0x18*/ u8 filler18[0x2C - 0x18];
    /*0x2C*/ s32 unk2C;
    /*0x30*/ s32 unk30;
    /*0x34*/ u8 filler34[0x40 - 0x34];
    /*0x40*/ s16 unk40;
    /*0x42*/ u8 filler42[2];
    /*0x44*/ u32 unk44[4];
    /*0x54*/ s16 unk54[4];
...
extern struct PilotWork lbl_10000000;
...
void lbl_000004E0(void)
{
    ...
    struct Struct802F1BFC *cfg = &lbl_802F1BFC;
    int i;
    // The original reserves 24 bytes of frame it never reads or writes;
    // without this the frame is 0x10 instead of 0x28.
    u8 unused[24];

    *(s16 *)(w + 0x40) = 0;
    *(u32 *)lbl_802F1FD0 = cfg->unk4;
