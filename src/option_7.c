/*
 * option.c -- REL module: isolated function lbl_0000057C.
...
static void lbl_0000057C(void)
{
    ...
    lbl_00007F90();
    *(s32 *)(lbl_10000000 + 0xD8) = 30;
    *(s16 *)lbl_100001B4 = 0;
    submodeFinishFunc = lbl_00000714;
    gameSubmodeRequest = 0xB1;
}
