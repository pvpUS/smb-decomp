/*
 * sel_ngc_rel.c -- REL module: isolated function lbl_0000A840.
...
void lbl_0000A840(struct Sprite *sprite);
...
// sprite destFunc: clear the "preview sprite exists" flag and free the image.
void lbl_0000A840(struct Sprite *sprite)
{
    *(s32 *)lbl_100009D4 = 0;
