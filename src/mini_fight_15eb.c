...
void lbl_0000823C(struct Effect *);
...
void lbl_0000823C(struct Effect *effect)
{
    struct FightPanel *p =
        &(*(struct FightPanel **)(lbl_100188E8 + 0x14))[effect->playerId];

    effect->unk88 = *(Vec *)(p->unk2C + 8);
    effect->unk88.y += *(f32 *)lbl_0001C178;
    effect->pos = effect->unk88;
    effect->state = p->unk1;
    effect->colorFactor = *(f32 *)lbl_0001C108;
    effect->model = commonGma->modelEntries[((u16 *)lbl_0001CBD0)[p->unk1]].model;
}
