...
void lbl_0000A5D0(struct Effect *effect)
{
    ...
    if (!(polyDisp.flags & 4))
    {
        ...
        avdisp_set_post_mult_color(effect->unk18, effect->unk1C, effect->unk20,
                                   *(f32 *)lbl_0001C10C);
        avdisp_set_z_mode(GX_ENABLE, GX_LEQUAL, GX_DISABLE);
        avdisp_set_bound_sphere_scale(s);
        avdisp_draw_model_culled_sort_all(m);
