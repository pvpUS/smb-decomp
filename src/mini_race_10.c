/*
 * mini_race.c -- REL module: isolated function lbl_00002B54.
...
void lbl_00002B54(struct Ball *ball);
...
void lbl_00002B54(struct Ball *ball)
{
    ...
    struct AnimChannel *ch = (struct AnimChannel *)decodedStageLzPtr->unk78;
    ...
    if (st->unk1CE > 5)
    {
        ...
        st->unk1D4 = st->unk1E8;
        st->unk1DC = st->unk1F0;
        lbl_000031C0(ch, &st->unk4, st->unk1D4);
    }
}
