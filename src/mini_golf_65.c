/*
 * mini_golf.c -- REL module: isolated function lbl_00023DD4.
...
void lbl_000240C0(NLsprarg *p, float a, float b);
...
void lbl_00023DD4(void)
{
    ...
    params.sprno = 0x44;
    params.x = *(f32 *)(pool + 0x170);
    params.y = *(f32 *)(pool + 0x22c);
    params.z = *(f32 *)(pool + 0x1b4);
    params.zm_x = *(f32 *)(pool + 0x4a8);
    params.zm_y = *(f32 *)(pool + 0x4ac);
    params.u0 = params.v0 = *(f32 *)(pool + 0x3b0);
    params.u1 = params.v1 = *(f32 *)(pool + 0x134);
    params.ang = 0;
    params.trnsl = *(f32 *)(pool + 0x134);
    params.listType = -1;
    params.attr = 10;
    params.base_color = -1;
    params.offset_color = 0;
    lbl_000240C0(&params, *(f32 *)(pool + 0x4b0), *(f32 *)(pool + 0x4b4));
    reset_text_draw_settings();
    set_text_font(0xB3);
    set_text_scale(*(f32 *)(pool + 0x4b8), *(f32 *)(pool + 0x134));
    set_text_mul_color(0xFFFF00);
    func_80071B1C(*(f32 *)(pool + 0x4bc));
    sum = 0;
    if ((s8)lbl_802F1BE8.unk4 == 0 || (s8)lbl_802F1BE8.unk4 == 1)
    {
        for (i = 0; i < lbl_00009404(); i++)
            sum += lbl_000093D4(modeCtrl.currPlayer, i) - 3;
    }
    else
    {
        for (i = 9; i < lbl_00009404(); i++)
            sum += lbl_000093D4(modeCtrl.currPlayer, i) - 3;
    }
    if (sum == 0)
    {
        new_ape_stat_motion(ballInfo[modeCtrl.currPlayer].ape, 5, 4, 0, *(f32 *)(pool + 0x3b0));
        set_text_pos(*(f32 *)(pool + 0x4c0), *(f32 *)(pool + 0x4c4));
        sprite_puts((char *)(tbl + 0x3abc));
        set_text_pos(*(f32 *)(pool + 0x4c0), *(f32 *)(pool + 0x4c8));
        sprite_puts((char *)(tbl + 0x3adc));
        set_text_pos(*(f32 *)(pool + 0x4c0), *(f32 *)(pool + 0x4cc));
        sprite_puts((char *)(tbl + 0x3b08));
        reset_text_draw_settings();
        set_text_font(9);
        set_text_mul_color(0xFFA000);
        func_80071B1C(*(f32 *)(pool + 0x4bc));
        set_text_scale(*(f32 *)(pool + 0x4d0), *(f32 *)(pool + 0x4d0));
        set_text_pos(*(f32 *)(pool + 0x20c), *(f32 *)(pool + 0x3c8));
        sprite_puts((char *)(tbl + 0x3b30));
    }
    else
    {
        new_ape_stat_motion(ballInfo[modeCtrl.currPlayer].ape, 5, 8, 0, *(f32 *)(pool + 0x3b0));
        set_text_pos(*(f32 *)(pool + 0x454), *(f32 *)(pool + 0x4c4));
        sprite_puts((char *)(tbl + 0x3b3c));
        set_text_pos(*(f32 *)(pool + 0x454), *(f32 *)(pool + 0x4c8));
        sprite_puts((char *)(tbl + 0x3b64));
        set_text_pos(*(f32 *)(pool + 0x454), *(f32 *)(pool + 0x4cc));
        sprite_puts((char *)(tbl + 0x3b88));
        reset_text_draw_settings();
        set_text_font(9);
        set_text_mul_color(0xFF4600);
        func_80071B1C(*(f32 *)(pool + 0x4bc));
        set_text_scale(*(f32 *)(pool + 0x4d0), *(f32 *)(pool + 0x4d0));
        set_text_pos(*(f32 *)(pool + 0x4d4), *(f32 *)(pool + 0x3c8));
        sprite_puts((char *)(tbl + 0x3bb0));
    }
}
