/*
 * test_mode.c -- REL module: isolated function lbl_00008BBC.
...
static asm void lbl_00008BBC(void)
{
    nofralloc
#include "../asm/nonmatchings/test_mode/lbl_00008BBC.s"
}
