 ...
 * byte-matching (part 2 of 55; contiguous .text range).  Each function
...
{
    nofralloc
#include "../asm/nonmatchings/mini_golf/_prolog.s"
}
asm void _epilog(void)
{
    nofralloc
#include "../asm/nonmatchings/mini_golf/_epilog.s"
}
asm void _unresolved(void)
{
    nofralloc
#include "../asm/nonmatchings/mini_golf/_unresolved.s"
}
