 ...
 * byte-matching (part 12 of 50; contiguous .text range).  Each function
...
// UNVERIFIED: 12-byte records at lbl_80285A80 (a DOL global), indexed by
// modeCtrl.currPlayer.  Only the two s16 flags at +4/+8 are used here.
