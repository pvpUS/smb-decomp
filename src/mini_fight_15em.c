...
void lbl_00009E88(struct Effect *);
...
void lbl_00009E88(struct Effect *effect)
{
    if ((polyDisp.flags & 4)
        && (effect->pos.y < *(f32 *)lbl_0001C108 || (effect->poolIndex & 1)))
        return;
    mathutil_mtxA_from_mtxB_translate(&effect->pos);
    mathutil_mtxA_sq_from_identity();
    mathutil_mtxA_rotate_z(
        effect->unkA4
        + (s16)(*(f32 *)lbl_0001C218
                * (mathutilData->mtxA[0][3] + mathutilData->mtxA[1][3])));
    ...
    nlObjPut(NLOBJ_MODEL(g_commonNlObj, NLMODEL_common_CROSS_LIGHT));
