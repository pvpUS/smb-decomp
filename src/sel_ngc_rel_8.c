/*
 * sel_ngc_rel.c -- REL module: isolated function lbl_00001D58.
...
// toggle the on-screen help panel (sprite tag 10) when the button is pressed.
int lbl_00001D58(void)
{
    ...
    {
        if (lbl_000005D4(8) || lbl_000005D4(7))
        {
            u_play_sound_0(0x70);
