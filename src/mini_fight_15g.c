...
void lbl_0000A974(void)
{
    ...
    SoundGroupFree();
    prev2 = OSSetCurrentHeap(stageHeap);
    u_free_minigame_graphics();
    OSSetCurrentHeap(prev2);
    bitmap_free_group(5);
    bitmap_free_group(9);
    modeCtrl.playerCount = w[0x138];
    g_poolInfo.playerPool.statusList[0] = w[0x13C];
    playerCharacterSelection[0] = w[0x140];
    g_poolInfo.playerPool.statusList[1] = w[0x13D];
    playerCharacterSelection[1] = w[0x141];
    g_poolInfo.playerPool.statusList[2] = w[0x13E];
    playerCharacterSelection[2] = w[0x142];
    g_poolInfo.playerPool.statusList[3] = w[0x13F];
    playerCharacterSelection[3] = w[0x143];
    event_finish_all();
