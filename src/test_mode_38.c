 ...
 * byte-matching (part 38 of 38; contiguous .text range).  Each function
...
static void lbl_0000D084(void);
static void lbl_0000D3C0(void);
static void lbl_0000D844(void);
static void lbl_0000D9FC(void);
static void lbl_0000DB2C(void);
static void lbl_0000DC60(void);
static void lbl_0000DDA4(void);
static void lbl_0000DF28(void);
static void lbl_0000E2E8(void);
static void lbl_0000E3E8(void);
static void lbl_0000E628(void);
static void lbl_0000ECB4(void);
static void lbl_0000EEF4(void);
static void lbl_0000F6F0(void);
static void lbl_0000F7BC(void);
void lbl_0000F940(void);
void lbl_0000FBA8(void);
void lbl_0000FD8C(void);

#pragma force_active on
asm void lbl_0000CB10(void)
{
    nofralloc
#include "../asm/nonmatchings/test_mode/lbl_0000CB10.s"
}
...
static asm void lbl_0000D084(void)
{
    nofralloc
#include "../asm/nonmatchings/test_mode/lbl_0000D084.s"
}
static asm void lbl_0000D3C0(void)
{
    nofralloc
#include "../asm/nonmatchings/test_mode/lbl_0000D3C0.s"
}
static asm void lbl_0000D844(void)
{
    nofralloc
#include "../asm/nonmatchings/test_mode/lbl_0000D844.s"
}
static asm void lbl_0000D9FC(void)
{
    nofralloc
#include "../asm/nonmatchings/test_mode/lbl_0000D9FC.s"
}
static asm void lbl_0000DB2C(void)
{
    nofralloc
#include "../asm/nonmatchings/test_mode/lbl_0000DB2C.s"
}
static asm void lbl_0000DC60(void)
{
    nofralloc
#include "../asm/nonmatchings/test_mode/lbl_0000DC60.s"
}
static asm void lbl_0000DDA4(void)
{
    nofralloc
#include "../asm/nonmatchings/test_mode/lbl_0000DDA4.s"
}
...
static asm void lbl_0000E2E8(void)
{
    nofralloc
#include "../asm/nonmatchings/test_mode/lbl_0000E2E8.s"
}
static asm void lbl_0000E3E8(void)
{
    nofralloc
#include "../asm/nonmatchings/test_mode/lbl_0000E3E8.s"
}
static asm void lbl_0000E628(void)
{
    nofralloc
#include "../asm/nonmatchings/test_mode/lbl_0000E628.s"
}
static asm void lbl_0000ECB4(void)
{
    nofralloc
#include "../asm/nonmatchings/test_mode/lbl_0000ECB4.s"
}
static asm void lbl_0000EEF4(void)
{
    nofralloc
#include "../asm/nonmatchings/test_mode/lbl_0000EEF4.s"
}
static asm void lbl_0000F6F0(void)
{
    nofralloc
#include "../asm/nonmatchings/test_mode/lbl_0000F6F0.s"
}
static asm void lbl_0000F7BC(void)
{
    nofralloc
...
asm void lbl_0000FD8C(void)
{
    nofralloc
#include "../asm/nonmatchings/test_mode/lbl_0000FD8C.s"
}
