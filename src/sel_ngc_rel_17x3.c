...
struct SelNgcState
{
    ...
    /*0x044*/ s32 unk44;
    /*0x048*/ s32 unk48[4];
    /*0x058*/ u8 filler58[0x68-0x58];
    /*0x068*/ s32 unk68;
    /*0x06C*/ s32 unk6C[10];
    /*0x094*/ s32 unk94[10];
    /*0x0BC*/ u8 fillerBC[0x110-0xBC];
    /*0x110*/ s32 unk110;
    /*0x114*/ s8 unk114;
};

#define SEL ((struct SelNgcState *)&lbl_801EEDA8)
...
void lbl_00002EC0(void)
{
    ...
    if (modeCtrl.courseFlags & (1 << 15))
    {
        SEL->unkC = -1;
        SEL->unkE = SEL->unkE - 1;
        SEL->unk0 = SEL->unk10[SEL->unkE];
        start_screen_fade(FADE_IN | FADE_ABOVE_SPRITES, 0, 30);
    }
    else if (modeCtrl.courseFlags & (1 << 16))
    {
        SEL->unkC = -1;
        SEL->unkE = SEL->unkE - 1;
        SEL->unk0 = 4;
    }
    else if (modeCtrl.courseFlags & (1 << 19))
    {
        SEL->unkC = -1;
        SEL->unkE = 1;
        lbl_00000234();
    ...
    else
    {
        ...
        lbl_00000234();
        SEL->unk0 = 4;
        start_screen_fade(FADE_UNK2 | FADE_ABOVE_SPRITES, 0, 1);
    }
    SEL->unk4 = -1;
    SEL->unk8 = 0;
    SEL->unk68 = -1;
    ...
    for (i = 0; i < SEL->unkE; i++)
    {
        if (SEL->unk94[i] == -1)
            break;
        sp = find_sprite_with_tag(SEL->unk94[i]);
        if (sp != NULL)
        {
            sp->userVar = 7;
            sp->textAlign = (s8)i;
