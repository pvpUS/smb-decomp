/*
 * mini_race.c -- REL module: isolated function _prolog.
...
void _prolog(void)
{
    set_minigame_callbacks(lbl_0000056C, lbl_000007EC,
                           (void (*)(struct Ball *))lbl_00003398,
                           (void (*)(struct Camera *, struct Ball *))lbl_00008C4C);
    lbl_00000228();
    gameSubmodeRequest = 0x99;
    if (debugFlags & (1 << 2))
        puts((char *)lbl_0001593C);
}
