...
void lbl_0000B3D4(void)
{
    ...
    if (modeCtrl.submodeTimer == 0x249)
        u_play_sound_0(lbl_0000EBF4() ? 0x184
                       : ((u32 *)lbl_0001CC44)[*(s16 *)(w + 0x148)]);
    t = modeCtrl.submodeTimer;
    if (t == 0 || (modeCtrl.unk18 == 0 && (g_currPlayerButtons[2] & PAD_BUTTON_A)))
    {
        *(s16 *)(w + 0x146) = 6;
        if (t > 0x249)
            u_play_sound_0(lbl_0000EBF4() ? 0x184
