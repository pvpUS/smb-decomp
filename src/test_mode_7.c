 ...
 * byte-matching (part 7 of 38; contiguous .text range).  Each function
...
static void lbl_00003C34(void);
static void lbl_00003D94(void);
static void lbl_000040B4(void);
static void lbl_0000502C(void);
void lbl_00005384(void);
static void lbl_000055E8(void);
static void lbl_000056BC(void);
static void lbl_000057C0(void);
static void lbl_000065F0(void);
static void lbl_00006974(void);
void lbl_000073EC(void);
static void lbl_00007BE0(void);
...
asm void lbl_00003A4C(void)
{
    nofralloc
#include "../asm/nonmatchings/test_mode/lbl_00003A4C.s"
}
static asm void lbl_00003C34(void)
{
    nofralloc
#include "../asm/nonmatchings/test_mode/lbl_00003C34.s"
}
static asm void lbl_00003D94(void)
{
    nofralloc
#include "../asm/nonmatchings/test_mode/lbl_00003D94.s"
}
static asm void lbl_000040B4(void)
{
    nofralloc
#include "../asm/nonmatchings/test_mode/lbl_000040B4.s"
}
static asm void lbl_0000502C(void)
{
    nofralloc
...
static asm void lbl_000055E8(void)
{
    nofralloc
#include "../asm/nonmatchings/test_mode/lbl_000055E8.s"
}
static asm void lbl_000056BC(void)
{
    nofralloc
#include "../asm/nonmatchings/test_mode/lbl_000056BC.s"
}
static asm void lbl_000057C0(void)
{
    nofralloc
#include "../asm/nonmatchings/test_mode/lbl_000057C0.s"
}
static asm void lbl_000065F0(void)
{
    nofralloc
#include "../asm/nonmatchings/test_mode/lbl_000065F0.s"
}
...
static asm void lbl_00007BE0(void)
{
    nofralloc
