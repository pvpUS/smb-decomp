/*
 * sel_ngc_rel.c -- REL module: isolated function lbl_0000A658.
...
void lbl_0000A658(struct Sprite *sprite);
...
// sprite destFunc: release the preview image the sprite owns.
void lbl_0000A658(struct Sprite *sprite)
{
