/*
 * mini_golf.c -- REL module: isolated function lbl_00025BD0.
...
void lbl_00025BD0(void)
{
    ...
    mathutil_mtxA_to_mtx(sp68);
    mathutil_mtxA_pop();

    mathutil_mtxA_push();
    mathutil_mtxA_mult_left(sp68);
    mathutil_mtxA_push();
    mathutil_mtxA_mult_left((f32 (*)[4])(st + 0x28));
    mathutil_mtxA_to_mtx(sp38);
    mathutil_mtxA_pop();
    mathutil_mtxA_push();
    mathutil_mtxA_mult_left((f32 (*)[4])(st + 0x58));
    ...
    GXLoadTexMtxImm(sp38, 0x1EU, GX_MTX2x4);
    GXSetTexCoordGen2(GX_TEXCOORD0, GX_TG_MTX2x4, GX_TG_POS, 0x1EU, GX_FALSE, 0x7DU);
    GXLoadTexObj_cached(*(GXTexObj **)(st + 0x20), GX_TEXMAP0);
    ...
    GXSetTevColorIn_cached(GX_TEVSTAGE0, GX_CC_ZERO, GX_CC_ZERO, GX_CC_ZERO, GX_CC_ONE);
    ...
    GXLoadTexMtxImm(sp8, 0x21U, GX_MTX2x4);
    GXSetTexCoordGen2(GX_TEXCOORD1, GX_TG_MTX2x4, GX_TG_POS, 0x21U, GX_FALSE, 0x7DU);
    GXLoadTexObj_cached(*(GXTexObj **)(st + 0x24), GX_TEXMAP1);
    ...
    GXSetTevColorIn_cached(GX_TEVSTAGE1, GX_CC_ZERO, GX_CC_CPREV, GX_CC_TEXC, GX_CC_ZERO);
    GXSetTevColorOp_cached(GX_TEVSTAGE1, GX_TEV_ADD, GX_TB_ZERO, GX_CS_SCALE_1, GX_TRUE, GX_TEVPREV);
    GXSetTevAlphaIn_cached(GX_TEVSTAGE1, GX_CA_ZERO, GX_CA_ZERO, GX_CA_ZERO, GX_CA_APREV);
