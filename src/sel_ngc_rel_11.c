/*
 * sel_ngc_rel.c -- REL module: isolated function lbl_00002484.
...
int lbl_00002484(int controllerId, int slot, int arg2);
...
// claim a selection slot for a pad and play that monkey's voice clip.
int lbl_00002484(int controllerId, int slot, int arg2)
{
    int c;

    ((s32 *)&lbl_801EEDA8)[slot + 18] = 1;
    playerControllerIDs[slot] = controllerId;
    lbl_802F1DFC = playerCharacterSelection[slot];
    u_somePlayerId = arg2;
    switch (playerCharacterSelection[slot])
    {
    case 0:
    ...
    case 1:
        ...
        break;
    case 2:
        u_play_sound_0(0x0028004F);
        break;
    case 3:
        u_play_sound_0(0x00FC004F);
        break;
    }
    u_play_sound_0(0x65);
    c = playerCharacterSelection[slot];
    {
        s32 *arr = (s32 *)&lbl_801EEDA8;
        arr[c + 22] = 30;
        lbl_802F1C10.unk4[slot] = (s8)c;
    }
    return 1;
}
