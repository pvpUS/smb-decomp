 ...
 * byte-matching (part 1 of 38; contiguous .text range).  Each function
...
{
    nofralloc
#include "../asm/nonmatchings/mini_pilot/_prolog.s"
}
asm void _epilog(void)
{
    nofralloc
#include "../asm/nonmatchings/mini_pilot/_epilog.s"
}
asm void _unresolved(void)
{
    nofralloc
#include "../asm/nonmatchings/mini_pilot/_unresolved.s"
}
static asm void lbl_000001F8(void)
{
    nofralloc
#include "../asm/nonmatchings/mini_pilot/lbl_000001F8.s"
}
