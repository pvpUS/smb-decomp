/*
 * mini_pilot.c -- REL module: isolated function _prolog.
...
void _prolog(void)
{
    set_minigame_callbacks(lbl_0000044C, lbl_00003B6C,
                           (void (*)(struct Ball *))lbl_00004F68,
                           (void (*)(struct Camera *, struct Ball *))lbl_00006DFC);
    puts((char *)lbl_0000C7CC);
    lbl_000001F8();
}
