 ...
 * byte-matching (part 15 of 17; contiguous .text range).  Each function
...
static void lbl_00009A98(void);
void lbl_00009B04(void);
void lbl_00009C18(void);
void lbl_00009F4C(void);
static void lbl_00009FB0(void);
static void lbl_0000A098(void);
void lbl_0000A69C(void);
static void lbl_0000A754(void);
...
asm void lbl_000099A4(void)
{
    nofralloc
#include "../asm/nonmatchings/mini_pilot/lbl_000099A4.s"
}
static asm void lbl_00009A98(void)
{
    nofralloc
#include "../asm/nonmatchings/mini_pilot/lbl_00009A98.s"
}
asm void lbl_00009B04(void)
{
    nofralloc
...
asm void lbl_00009F4C(void)
{
    nofralloc
#include "../asm/nonmatchings/mini_pilot/lbl_00009F4C.s"
}
static asm void lbl_00009FB0(void)
{
    nofralloc
#include "../asm/nonmatchings/mini_pilot/lbl_00009FB0.s"
}
static asm void lbl_0000A098(void)
{
    nofralloc
#include "../asm/nonmatchings/mini_pilot/lbl_0000A098.s"
}
asm void lbl_0000A69C(void)
{
    nofralloc
#include "../asm/nonmatchings/mini_pilot/lbl_0000A69C.s"
}
static asm void lbl_0000A754(void)
{
    nofralloc
#include "../asm/nonmatchings/mini_pilot/lbl_0000A754.s"
}
asm void lbl_0000AD6C(void)
{
    nofralloc
#include "../asm/nonmatchings/mini_pilot/lbl_0000AD6C.s"
}
asm void lbl_0000AE94(void)
{
    nofralloc
#include "../asm/nonmatchings/mini_pilot/lbl_0000AE94.s"
}
asm void lbl_0000AEE0(void)
{
    nofralloc
#include "../asm/nonmatchings/mini_pilot/lbl_0000AEE0.s"
}
