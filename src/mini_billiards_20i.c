 ...
 * byte-matching (part 20 of 55; contiguous .text range).  Each function
...
void lbl_00005654(void)
{
    u8 *q = lbl_10000000;
    u8 *p = lbl_0001C2B8;
    struct BilliardsApe *w = &((struct BilliardsApe *)(q + 0x9878))[9];
    int i;
    int c;

    if (((struct BilliardsApe *)(q + 0x9878))[9].unk0 != 1) {
        if (*(s32 *)(q + 0x20) == 0x1E) {
            *(s8 *)(q + 0x13) = 0x1E;
        ...
        if (w->unk0 != 1) {
            ...
            *(s8 *)(q + 0xA) = 0x16;
            if (*(s16 *)(q + 0x1A) == 0) {
                *(s8 *)(q + 0x12) = 1;
                for (i = 1; i < 10; i++) {
                    if (((struct BilliardsApe *)(q + 0x9878))[i].unk0 == 1) {
                        *(s8 *)(q + 0x12) = 0;
                        break;
                    }
                }
            ...
            if (((struct BilliardsPlayer *)(q + 0xA64))[lbl_802F1C32].unk2 != 0)
            ...
            lbl_0001723C();
            *(s8 *)(q + 2) = 0;
            ((struct BilliardsPlayer *)(q + 0xA64))[lbl_802F1C32].unk4 += 1;
            lbl_00008EC0(0xD, 1);
        } else {
            if (*(s8 *)(q + 0xF) == 0) {
                lbl_00008EC0(3, 1);
                ...
                *(s16 *)(q + 0x1A) += 1;
                c = lbl_802F1C32;
                lbl_802F1DFC = ((struct BilliardsPlayer *)(q + 0xA64))[c].chara;
                u_somePlayerId = c;
                u_play_sound_0(0x1E);
            }
            lbl_00003F4C();
