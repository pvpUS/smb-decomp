 ...
 * byte-matching (part 16 of 94; contiguous .text range).  Each function
...
struct FightWork
{
    ...
    u32 unk88C;               // 0x88C
    u8 unk890[0x18];          // 0x890
    struct FightRec rec[17];  // 0x8A8
};
extern struct FightWork lbl_10017520;
typedef void (*FightVoidFunc)(void);
extern FightVoidFunc lbl_0001CBE0[];
...
void lbl_0000AAD0(void)
{
    ...
    *(u16 *)((u8 *)w + 0x144) = *(u16 *)((u8 *)w + 0x146);
    lbl_0001CBE0[w->unk144]();
