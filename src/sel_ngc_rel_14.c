/*
 * sel_ngc_rel.c -- REL module: isolated function lbl_000027AC.
...
// move the course selection one entry backwards.
int lbl_000027AC(void)
{
    int idx;

    u_play_sound_0(0x6C);
    if (lbl_802F1FB4->flags & 0x10)
        lbl_0000259C();
    ...
    idx = lbl_802F1FB4->unk2;
    if (lbl_802F1FB4->flags & 8)
        idx += 3;
    if (lbl_802F1FB4->flags & 0x10)
        idx += 3;
    lbl_802F1FB4->unk0 = ((s32 *)lbl_10000018)[idx];

    if (*(s32 *)lbl_802F1FA8 != 0
     && !is_floor_visited(lbl_802F1FB4->unk2, lbl_802F1FB4->unk0,
                          lbl_802F1FB4->flags))
    {
        *(s32 *)lbl_802F1FA8 = 0;
        return 0;
