/*
 * mini_fight.c -- REL module: isolated function run lbl_0000FD38 .. lbl_0000FEC4.
...
void lbl_0000FD38(void)
{
    void **pp = (void **)(lbl_100188E8 + 0x14);
    u32 *p = (u32 *)*pp;
    p[1] = (u32)lbl_0001CCA0;
    p[2] = 0x10;
    p = (u32 *)*pp;
    p[0] = p[1];
}
...
void lbl_0000FD90(void)
{
    u32 *p = *(u32 **)(lbl_100188E8 + 0x14);
    p[1] = (u32)lbl_0001CE60;
    if (*(s32*)((u8 *)&modeCtrl + 0x24) < 4)
        p[2] = 4;
    else
        p[2] = 3;
    p = *(u32 **)(lbl_100188E8 + 0x14);
    p[0] = p[1];
}
void lbl_0000FDE4(void)
{
...
int lbl_0000FE80(void)
{
    int count = *(s32*)((u8 *)&g_poolInfo + 0x28);
    u8 *p = lbl_10000118;
    int n = 0;
    int i;
    for (i = 0; i < count; i++) {
