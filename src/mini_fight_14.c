 ...
 * byte-matching (part 14 of 94; contiguous .text range).  Each function
...
extern struct EffectFuncs lbl_0001CB40[];
...
void lbl_00007444(void)
{
    effect_replace_type_funcs(0x18, &lbl_0001CB40[0]);
    effect_replace_type_funcs(0x19, &lbl_0001CB40[1]);
    effect_replace_type_funcs(0x1A, &lbl_0001CB40[2]);
    effect_replace_type_funcs(0x1C, &lbl_0001CB40[3]);
    effect_replace_type_funcs(0x1D, &lbl_0001CB40[4]);
    effect_replace_type_funcs(0x1E, &lbl_0001CB40[5]);
    effect_replace_type_funcs(0x1F, &lbl_0001CB40[6]);
    effect_replace_type_funcs(0x2A, &lbl_0001CB40[7]);
    effect_replace_type_funcs(0x2B, &lbl_0001CB40[8]);
}
