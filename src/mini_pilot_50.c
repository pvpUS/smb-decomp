/*
 * mini_pilot.c -- REL module: isolated function lbl_0000AEE0.
...
s32 lbl_0000AEE0(s16 *pa, s16 *pb);
...
s32 lbl_0000AEE0(s16 *pa, s16 *pb)
{
    ...
    if (((s32 *)lbl_10000044)[a] < ((s32 *)lbl_10000044)[b])
        return 1;
    if (((s32 *)lbl_10000044)[a] > ((s32 *)lbl_10000044)[b])
        return -1;
    if (((s16 *)lbl_10000054)[a] < ((s16 *)lbl_10000054)[b])
        return -1;
    if (((s16 *)lbl_10000054)[a] > ((s16 *)lbl_10000054)[b])
        return 1;
    return 0;
