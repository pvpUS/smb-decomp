...
void lbl_00007F7C(struct Effect *);
...
void lbl_00007F7C(struct Effect *e)
{
    f32 scale = e->scale.x;
    struct GMAModel *model = e->model;
    Vec v;
    f32 t;
    f32 q;
    ...
    t = -v.z;
    q = (t - model->boundSphereRadius * scale) / t;
    v.x = v.x * q;
    v.y = v.y * q;
    v.z = v.z * q;
    scale = scale * (*(f32 *)lbl_0001C128 * (model->boundSphereRadius * q));
