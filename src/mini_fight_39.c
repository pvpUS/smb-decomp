/*
 * mini_fight.c -- REL module: isolated function run lbl_0001A330 .. lbl_0001A360.
...
void lbl_0001A330(int arg);
void lbl_0001A348(int arg);
void lbl_0001A360(int arg);
...
void lbl_0001A360(int arg)
{
    *(s16*)(lbl_10018FD4 + 0x48) = 1;
    *(s16*)(lbl_10018FD4 + 0x4a) = (s16)arg;
}
