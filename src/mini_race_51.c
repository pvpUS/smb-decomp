 ...
 * byte-matching (part 51 of 79; contiguous .text range).  Each function
...
asm void lbl_0000DE5C(void)
{
    nofralloc
#include "../asm/nonmatchings/mini_race/lbl_0000DE5C.s"
}
static asm void lbl_0000DF6C(void)
{
    nofralloc
