/*
 * test_mode.c -- REL module: isolated function lbl_00008350.
...
static asm void lbl_00008350(void)
{
    nofralloc
#include "../asm/nonmatchings/test_mode/lbl_00008350.s"
}
