/*
 * sel_ngc_rel.c -- REL module: isolated function lbl_000029A8.
...
// restart the preview stage for the currently highlighted entry.
void lbl_000029A8(void)
{
    event_finish(1);
    event_finish(4);
    ...
    event_finish(13);
    event_finish(19);
    background_set_random_seed(*(s32 *)lbl_1000003C);
    load_stage(*(s32 *)lbl_1000003C);
    event_start(1);
    event_start(4);
    event_start(5);
    event_start(13);
    event_start(19);
    if (((s32 *)&lbl_801EEDA8)[0] > 0x14
     || ((s32 *)&lbl_801EEDA8)[1] == 0x1A
     || ((s32 *)&lbl_801EEDA8)[1] == 0x1B
     || ((s32 *)&lbl_801EEDA8)[1] == 32
     || ((s32 *)&lbl_801EEDA8)[1] == 33
     || ((s32 *)&lbl_801EEDA8)[1] == 37
     || ((s32 *)&lbl_801EEDA8)[1] == 38
     || ((s32 *)&lbl_801EEDA8)[1] == 0x33
     || ((s32 *)&lbl_801EEDA8)[1] == 0x36)
    {
