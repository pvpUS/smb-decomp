/*
 * sel_ngc_rel.c -- REL module: isolated function lbl_0000A7B0.
...
void lbl_0000A7B0(s8 *alive, struct Sprite *sprite);
...
// sprite mainFunc: pump the preview image loader.
void lbl_0000A7B0(s8 *alive, struct Sprite *sprite)
{
    preview_main(*(void **)((u8 *)sprite + 0x2C));
}
