/*
 * mini_race.c -- REL module: isolated function lbl_000044AC.
...
void lbl_000044AC(struct Ball *ball)
{
    ...
    else if (globalAnimTimer & 4)
        ball->flags &= ~0x10;
    else
        ball->flags |= 0x10;
}

static void lbl_00004540(struct Ball *ball)
{
