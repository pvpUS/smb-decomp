# test_mode data segment 6 -- .data HEAD, ahead of the carved hole at
# 0x14810 (lbl_00009060's switch jump table, now emitted by
# src/test_mode_62.c).  Carries NO .text and NO .rodata, so it
# relocates freely; SOURCES order is load-bearing (it must sit before
# src/test_mode_62.c).  lbl_00014810 survives as a zero-size label at
# the hole's start.
.include "macros.inc"
.global lbl_000102B0
.global lbl_00010350
